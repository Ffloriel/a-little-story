...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/d3.min.js":[function(require,module,exports) {
var define;
...
!function () {
  ...
  function Ce(n, t, e, r, u) {
    ...
    if (n.forEach(function (n) {
      ...
      for (var s, f, h = i[0];;) {
        ...
        do {
          if (g.v = g.o.v = !0, g.e) {
            if (p) for (var a = 0, l = s.length; l > a; ++a) {
              u.point((f = s[a])[0], f[1]);
  ...
  function Ao(n, t) {
    var e = n.length - 1;
    if (e) for (var r, u, i = n[0][0], o = n[0][1], a = n[e][0] - i, c = n[e][1] - o, l = -1; ++l <= e;) {
  ...
  ta.range = function (n, t, e) {
    ...
    var r,
        ...
        i = a(ga(e)),
        o = -1;
    if (n *= i, t *= i, e *= i, 0 > e) for (; (r = n + e * ++o) > t;) {
      u.push(r / i);
    } else for (; (r = n + e * ++o) < t;) {
      u.push(r / i);
    }
  ...
  ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function () {
    ...
    return a.tick = function () {
      ...
      if ((d = r * v) && (y = l[0] / 2, x = l[1] / 2, e = -1, d)) for (; ++e < b;) {
        a = m[e], a.x += (y - a.x) * d, a.y += (x - a.y) * d;
      }
      if (g) for (Ju(t = ta.geom.quadtree(m), r, o), e = -1; ++e < b;) {
      ...
      if (u = [], "function" == typeof f) for (t = 0; s > t; ++t) {
        u[t] = +f.call(this, M[t], t);
      } else for (t = 0; s > t; ++t) {
        u[t] = f;
      }
      if (i = [], "function" == typeof h) for (t = 0; s > t; ++t) {
  ...
  ta.layout.histogram = function () {
    ...
    return i.size = function (n) {
      ...
      var r;
      return f = null == (s = n) ? Ri : "function" == (r = _typeof(n)) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i;
    }, i.round = function (n) {
  ...
  }), "function" == typeof define && define.amd ? define(ta) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = ta), this.d3 = ta;
}();
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/d3.min.js"], null)
//# sourceMappingURL=/d3.min.433ec67a.map